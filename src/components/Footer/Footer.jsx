...
const Footer = () => {
  return (
    <div className="relative z-50 text-white bg-gray-800 ">
      <section className="max-w-[1200px] mx-auto text-white">
          ...
          <div className=" py-8 px-4 ">
            ...
            <div className="flex items-center h-10">
              <input
                ...
                placeholder="Email"
              />
              <button className="bg-blue-500 hover:bg-orange-500/75 h-full inline-block py-2 px-6 text-white">
                Ok
              </button>
            </div>
          </div>
        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-6 border-t-2 border-gray-300/40">
            <span className="text-sm text-gray-400 cursor-auto">
